...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param firstName a string indicating the first part of the Silly instance's name.
     * @param secondName a string indicating the second part of the Silly instance's name.
     */
    public Silly(String firstName, String secondName) { this.name = firstName + secondName; }
